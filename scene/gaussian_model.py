...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int):
        ...
        self.loc_positions= torch.empty(0)
        #===================
        #WDD 5-6
        #创建keyframe_meshes属性
    ...
    def get_xyz(self):
        ...
        #因为当前数据是blender生成的！！！！！！！！！！！
        #处理blender的数据问题
        #transform_matrices[:3, 1:3] *= -1

        # 局部坐标点
        #local_points = torch.stack([loc_x, loc_y, loc_z], dim=1).unsqueeze(-1)
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, keyframe_meshes:dict, spatial_lr_scale : float):
        ...
        self.loc_positions  = torch.tensor(np.asarray(pcd.loc_positions)).float().cuda()   
        self.keyframe_meshes={}
        ...
        #WDD 5-6 这里使用self._xyz.shape，避免初始的时候产生错误
    ...
    def prune_points(self, mask):
        ...
        self.loc_positions  =   self.loc_positions[valid_points_mask]
        #===================
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation,new_indices,new_loc_positions):
        d = {"xyz": new_xyz,
        ...
        self.loc_positions  =   torch.cat((self.loc_positions, new_loc_positions), dim=0)  
        #=====================
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        new_loc_positions   = self.loc_positions[selected_pts_mask].repeat(N,1)
       
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacity, new_scaling, new_rotation,new_indices,new_loc_positions)
        #============
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        new_loc_positions   = self.loc_positions[selected_pts_mask]
         
         
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation,new_indices,new_loc_positions)
        #============
    ...
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size):
        ...
        #=============================================
        a = self._xyz
        b = self.loc_positions
 
        # 计算每对点之间的距离
        distances = torch.norm(a - b, dim=1, p=2)

        # 设置阈值
        threshold = 5 
        # 创建距离大于阈值的掩码
        dist_mask = distances > threshold
 
        self.prune_points(dist_mask)
        #=============================================
